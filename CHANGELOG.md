...
- Wrike: support new UI [#1165](https://github.com/everii-Group/mocoapp-browser-extension/pull/1165)
...
- Update selector for reading description from GitHub issues
- Prevent error when toggling the popup on pages without a service
...
- Clickup: position the bubble in the bottom center of the screen

## [2.15.0] – 2026-03-23

### Added

- Support GitLab work item URLs for time booking [#1095](https://github.com/everii-Group/mocoapp-browser-extension/pull/1095)
...
- Update Asana CSS-Selector for H1 [#1071](https://github.com/everii-Group/mocoapp-browser-extension/pull/1071)
...
- Add issues project URL to youtrack [61841dd](https://github.com/everii-Group/mocoapp-browser-extension/commit/61841dd4973074b780622a4c410a4fcdf307c86b)

## [2.12.4] – 2025-10-23

### Added

- Add target URLs for issues in project agile boards and agile boards to youtrack [#1048](https://github.com/everii-Group/mocoapp-browser-extension/pull/1048)

## [2.12.3] – 2025-10-20

### Added

- Add project issue URL to youtrack [#1047](https://github.com/everii-Group/mocoapp-browser-extension/pull/1047)
...
- Require description if it is set to be mandatory in MOCO
...
- Reading title from GitLab [#977](https://github.com/everii-Group/mocoapp-browser-extension/pull/977)
...
- Added additional asana url-patterns

## [2.8.1] - 2025-02-05

### Added

- Small awork community service improvement [#911](https://github.com/everii-Group/mocoapp-browser-extension/pull/911)
...
- Correctly remove the tag from the description if the description contains only a tag
- Fix re-opening the popup in Asana

## [2.7.4] – 2024-10-07

### Fixed

- Fix display of popup in Clickup

## [2.7.3] – 2024-10-02

### Fixed

- Make sure focus-trap is created after form mounted
